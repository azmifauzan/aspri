...
export default function EditContactModal({ isOpen, onClose, onSave, contact, isSaving }: EditContactModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
      <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-xl w-full max-w-md">
        <div className="flex justify-between items-center p-4 border-b dark:border-zinc-700">
          <h2 className="text-lg font-semibold">{t('contacts.edit_contact')}</h2>
